  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <footer class="bg-dark text-white py-3">
        <div class="container text-center">
            <p class="mb-0">@2024 Dribble Designed and developed by Elavarasan M</p>
        </div>
    </footer>
...
```
# OUTPUT:
![8e8bdfe6-142f-4e3f-98e7-6392e4b8ec0e](https://github.com/user-attachments/assets/d5d9be22-709e-454f-83eb-de725ca1e44f)
